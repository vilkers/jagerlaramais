...
/* ---------- GEOMETRIA DO MAPA ---------- */
/* Mora em data/mapa.js — junto com as rotas, as bases, as torres e o poço.
   Saiu daqui na v0.6.4 para que o guia pudesse desenhar O MESMO mapa em vez de
   manter um 7×7 escrito à mão. Este arquivo não guarda conteúdo nem geometria:
   guarda REGRA. O que continua aqui embaixo é o que depende do estado da partida
   (`limitaFrente`) ou é número de balanceamento (vida de torre, revide). */
