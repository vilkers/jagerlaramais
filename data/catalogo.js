...
mirrha:{n:"Emerson Emo",ep:"a Trilha Sonora",pos:"sup",cls:"Suporte",ref:"Lulu / Janna",
  ...
  habs:[{n:"Ombro Amigo",f:1,alvo:"al",ef:{escudo:4,cura:5}},
        {n:"Empresta o Fone",f:1,alvo:"al",ef:{doar:1}},
...
kurr:{n:"Valti",ep:"o Homem do Coco",pos:"selva",cls:"Assassino",ref:"Nidalee / Elise",
  ...
  habs:[{n:"Facão",f:1,alvo:"in",ef:{dano:1}},
        {n:"Talho de Facão",f:2,alvo:"in",ef:{dano:1,marca:4,dot:{tipo:"sangramento",dano:1,rodadas:2}}},
...
nira:{n:"Gari Mago",ep:"o Guardião da Limpeza",pos:"meio",cls:"Mago",ref:"Orianna / Anivia",
  vida:18,poder:3,arm:1,alc:3,
  habs:[{n:"Varrida Purificadora",f:1,alvo:"in",ef:{dano:1}},
        {n:"Redemoinho Sustentável",f:3,alvo:"in",ef:{dano:1,prende:1}},
        {n:"Coleta Seletiva Suprema",f:5,alvo:"in",ef:{dano:1,area:1,zona:{tipo:"veneno",dano:2,raio:1}}}]},
...
gorm:{n:"Caramêlo 2.0",ep:"o Cachorro Pilotado",pos:"sup",cls:"Suporte",ref:"Braum / Alistar",
  ...
  habs:[{n:"Latido",f:1,alvo:"in",ef:{dano:1,empurrar:1}},
        {n:"Escudo de Pelo",f:1,alvo:"al",ef:{escudo:4}},
        {n:"Latido Caótico",f:5,alvo:"eu",ef:{danoVizinhos:1,prendeVizinhos:1}}]},
