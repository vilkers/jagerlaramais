...
|---|---|
| **Comeback** | **É a próxima coisa.** Sobra 56,5% de vantagem para quem abre, e medição mostrou que não é mapa (N=9 dá o mesmo 60%) nem ouro (+10 por herói não move). É a bola de neve sem freio. |
| **Mapa maior** | Vale pelo espaço — hoje suporte e atirador não dividem rota. **Não** conserta a assimetria e cobra caro: mediana vai de 12 para 18 rodadas em N=9. Trocar `const N` já basta; falta calibrar o resto. |
